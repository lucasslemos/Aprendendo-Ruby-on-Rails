class AdminsBackoffice::QuestionsController < AdminsBackofficeController
  ...
  def update
    if @question.update(params_question)
      redirect_to admins_backoffice_questions_path, notice: "Questão autalizada com sucesso!"
    else
      render :edit
    end
  end
  ...
  def destroy
    if @question.destroy
      redirect_to admins_backoffice_questions_path, notice: "Apagando Questão!"
    else
      render :index
    end
  end
